...
public partial class Admin_reports_TAT_duration : System.Web.UI.Page
{
    ...
    private void SearchData() //Search function
    {
        ...
        query = "SELECT scar_no, supplier_contact, issued_date, expected_date_close, modified_by, last_modified FROM dbo.SCAR_Request WHERE DATEDIFF(dd, issued_date, expected_date_close) LIKE '" + txtDuration.Text + "'";
