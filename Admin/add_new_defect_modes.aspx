                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                ...
                                <asp:RegularExpressionValidator ID="RegularExpressionValidatorIPCCode" runat="server"
                                    ErrorMessage="* IPC Code ONLY accept numbering format (Eg: 1.1.1)" ForeColor="Red" ControlToValidate="txtNewIPCCode" ValidationExpression="^[0-9]+(\.[0-9]{1,2})+(\.[0-9]{1,2})?$"></asp:RegularExpressionValidator>
                            </div>
                            <br /><br />
                        </div>
                        <div class="form-group">
