    ...
    <div class="right-panel-inner">
        <div class="col-md-12">
                            ...
                            <div class="panel-group" id="accordion2">
                                ...
                                <div class="form-group">
                                    <asp:GridView CssClass="table table-condensed" ID="AttachmentsGridView" runat="server" 
                                         AllowSorting="true" OnSorting="AttachmentsGridView_Sorting"
            ...
            BorderStyle="Solid" BorderWidth="1px">
                ...
                BorderStyle="Solid" BorderWidth="1px" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="checkbox">
                                                <label>
                                                <asp:CheckBox ID="chk8Dapproval" runat="server" OnCheckedChanged="Approval_CheckedChanged" AutoPostBack="true" />
                                            </div> 
                                            <asp:Label ID="lblWCM" runat="server" Font-Bold="true" Text="WCM" Visible="false"/>
                                                <asp:Panel ID="pnlDropDownListWCM" runat="server">
                                                    <asp:DropDownList ID="lstWCM" CssClass="form-control" runat="server" Visible="false"/>
                                                </asp:Panel>
                                            <asp:Label ID="lblQM" runat="server" Font-Bold="true" Text="QM" Visible="false"/>
                                                <asp:Panel ID="pnlDropDownListQM" runat="server">
                                                    <asp:DropDownList ID="lstQM" CssClass="form-control" runat="server" Visible="false"/>
                                                </asp:Panel>
                                                </label>
                                            <br />
                                            </ContentTemplate>
                ...
                BorderStyle="Solid" BorderWidth="1px" />
                                        <Columns>
                                            <asp:BoundField DataField="WCM Name" HeaderText="WCM Name" />
                                            ...
                                            <asp:BoundField DataField="QM Name" HeaderText="QM Name" />
