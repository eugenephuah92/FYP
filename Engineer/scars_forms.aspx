                            ...
                            <div class="panel-group" id="accordion2">
                                ...
                                <div class="form-group">
                                    <asp:GridView ID="AttachmentsGridView" runat="server" 
                                        ...
                                        DataKeyNames="response_id" BorderColor="#CCCCCC" Width="100%"
            ...
            <RowStyle Height="20px" Font-Size="13px" BorderColor="#CCCCCC" BorderStyle="Solid"
                BorderWidth="1px" />
                                    ...
                                    <asp:SqlDataSource ID="AttachmentsSqlDataSource" runat="server"
                                        SelectCommand="SELECT response_id, file_name
                                            FROM dbo.SCAR_attachments "
                                            
                                        DeleteCommand="Delete from dbo.SCAR_attachments where response_id = 
                                            @response_id" 
                                        ConnectionString="<%$ ConnectionStrings:AutoSCARConnectionString %>">
                                        <DeleteParameters>
                                            <asp:Parameter Name="response_id" />
                                ...
                                </div><!--End of Upload File Attachments-->
