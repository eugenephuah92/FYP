                            ...
                            <div class="panel-group" id="accordion2">
                                ...
                                <div class="form-group">
                                    <asp:GridView CssClass="table table-condensed" ID="AttachmentsGridView" runat="server" 
                                        ...
                                        DataKeyNames="scar_id" BorderColor="#CCCCCC" Width="100%"
                                ...
                                <div class="form-group">
                                        ...
                                        <div class="col-lg-4">
                                            <asp:DropDownList CssClass="form-control" ID="lstCurrentStatus" runat="server">
                                                <asp:ListItem Value="SCAR Type 2 Accepted">SCAR Type 2 Accepted</asp:ListItem>
                                                <asp:ListItem Value="SCAR Type 2 Rejected">SCAR Type 2 Rejected</asp:ListItem>
                                                <asp:ListItem Value="SCAR Type 4 Accepted">SCAR Type 4 Accepted / SCAR Closure</asp:ListItem>
                                                <asp:ListItem Value="SCAR Type 4 Rejected">SCAR Type 4 Rejected</asp:ListItem>
                                            </asp:DropDownList>
                                        </div>
                                        <div class="col-lg-4">
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-8 col-lg-offset-3">
                                            ...
                                            <asp:Button CssClass="btn btn-success" ID="btnParse" runat="server" OnClick="Parse_Data_Into_Notepad" Text="Parse" />
                                        </div>
                                    </div>
