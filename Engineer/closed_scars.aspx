<%@ Page Title="Auto SCAR &amp; TAT - Closed SCARS" EnableEventValidation="false" Language="C#" MasterPageFile="~/Engineer.Site.Master" AutoEventWireup="true" Inherits="Engineer_closed_scars" Codebehind="~/Engineer/closed_scars.aspx.cs"%>
                    ...
                    <form class="form-horizontal pad10" action="#" method="post">
                            <div class="form-group">
                                <div class="col-lg-12" style="padding-left:25pt; padding-right:30pt; padding-top:15pt">
                                	<!-- Table -->
                                   <asp:GridView ID="displayClosedSCAR" runat="server" CellPadding="4" ForeColor="#333333" Width="100%" OnPageIndexChanging="OnPageIndexChanging" AutoGenerateColumns="false" AllowPaging="true" PageSize="10" CssClass="table">
                                       <Columns>
