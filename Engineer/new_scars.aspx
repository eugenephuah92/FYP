<%@ Page Title="Auto SCAR &amp; TAT - New SCARS" EnableEventValidation="false" Language="C#" MasterPageFile="~/Engineer.Site.Master" AutoEventWireup="true" Inherits="Engineer_new_scars" Codebehind="~/Engineer/new_scars.aspx.cs"%>
                    ...
                    <form class="form-horizontal pad10" action="#" method="post">
                            <div class="form-group">
                                <div class="col-lg-12" style="padding-left:25pt; padding-right:30pt; padding-top:15pt">
                                	<!-- Table -->
                                   <asp:GridView ID="displayNewSCAR" CellPadding="4" ForeColor="#333333" Width="100%" AllowSorting="true" OnSorting="SCARGridView_Sorting" runat="server" OnPageIndexChanging="OnPageIndexChanging" AutoGenerateColumns="false" AllowPaging="true" PageSize="10" CssClass="table">
                                       <Columns>
                                        ...
                                        <EmptyDataTemplate>
                                            <label style="color: Red; font-weight: bold">No records found for Closed SCARS !</label>
                                        </EmptyDataTemplate>
                                       </asp:GridView>
